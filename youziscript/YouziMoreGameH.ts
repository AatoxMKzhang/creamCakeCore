...
export default class YouziMoreGameH extends ui.youzi.Youzi_MoreGameHUI {
    ...
    private initCustomParams(params)  {
        if (params)  {
            ...
            this.MoreGameUI.pos((Laya.stage.width - this.MoreGameUI.width * this.scaleMoreGameUIH) / 2,
                (Laya.stage.height - this.MoreGameUI.height * this.scaleMoreGameUIH) / 2);
        }
    }
